...
void handle_event(SDL_Event event, Game *game) {
    ...
    case SDL_MOUSEBUTTONDOWN:
        handle_mouse_event(event.button.button, true, event.button.x, event.button.y, game);
        break;
    case SDL_MOUSEBUTTONUP:
        handle_mouse_event(event.button.button, false, event.button.x, event.button.y, game);
        break;
    }
}
